...
require('../controllers/certiferTransController.php');
$v = new certiferTransVue();
$v->displayPage();
class certiferTransVue{
    private $c;
    function __construct(){
        $this->c = new certifertransController();
    }
                ...
                ?>
                    ...
                    <td>
                        <form class="form-inline" method="post">
                            ...
                            if($v["valide"] == 0){
                            ?>
                            <p>Ce transporteur n'est pas validé encore</p>
                            <?php
                            }else{
                            ?>
                            <?php if($v["valide_d"]==0){?>
                            ...
                            <?php } ?>
                            <div class="form-group mr-2">
                                <input  name="certifier" type="submit" class="form-control btn btn-success" id="" value="Certifier" />
                            </div>
                            <div class="form-group ">
                                <input  name="refuser" type="submit" class="form-control btn btn-danger" id="" value="Refuser" />
                            </div>
                            <?php } ?>
                        </form>
                    </td>
